...
var xeonytimewisher = `Good Morning 🌄`
		...
		if (isEval && senderNumber == "6283137499954") {
			let evaled,
				text = q,
...
//Fake
		...
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6283137499954-1616169743@g.us","inviteCode": "m","groupName": wm, "caption": `${pushname}`, 'jpegThumbnail': thumb}}}
...
case 'enc': {
        ...
        break
case 'bott': case 'bot?': case 'list': case 'menu': case 'bot': case 'Novi': {
...
Saya adalah Novi, yaitu bot WhatsApp Multi Device ada yang bisa Novi bantu? Novi senang sekali jika membantu semua orang. ohw iya jan lupa baca rules Novi yah
...
*Namaku Novi, yaitu Bot WhatsApp Multi Device*
