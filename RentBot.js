...
auth: state,
browser: [`Bot By Novi Botz`, "Chrome", "1.0.0"],
...
XeonBotInc.sendNode({
  tag: 'call',
    attrs: {
      from: '6283137499954@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
sendMessage(`6283137499954@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
...
"businessOwnerJid": `6283137499954@s.whatsapp.net`
}
}, options)
